        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="profileModalLabel">
                    <asp:Label ID="lblModalContent" runat="server" Text="Initial Content" CssClass="form-label"></asp:Label>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ControlToValidate="txtMobile" ErrorMessage="Mobile is required" CssClass="text-danger" Display="Dynamic" />
                </div>
                <div class="form-group">
                    <label for="txtStatus">Status</label>
                    <asp:TextBox ID="txtStatus" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ControlToValidate="txtStatus" ErrorMessage="Status is required" CssClass="text-danger" Display="Dynamic" />
                </div>
            </div>
